...
namespace Laba4_GeneticAlgorithm
{
    class F1
    {
        ...
        public static int F1Left(int u, int w, int x, int y, int z)
        {
        ...
        public static (long, List<int>) CreateChild((long, List<int>) parent1, (long, List<int>) parent2)
        {
            ...
            coeficientOfSurviving = Math.Abs(f1Right - F1Left(childNumbers[0], childNumbers[1], childNumbers[2], childNumbers[3], childNumbers[4]));
        ...
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i < sizeOfPopulation; i++)
            {
                ...
                int coeficientOfSurviving = Math.Abs(f1Right - F1Left(numbers[0], numbers[1], numbers[2], numbers[3], numbers[4]));
            ...
            while (bestestCoeficientOfSurviving != 0)
            {
                ...
                for (int i = 0; i < childrens.Count; i++)
                {
                    ...
                    int item1 = Math.Abs(f1Right - F1Left(childrens[i].Item2[0], childrens[i].Item2[1], childrens[i].Item2[2], childrens[i].Item2[3], childrens[i].Item2[4]));
